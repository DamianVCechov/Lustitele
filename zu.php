...
<html lang="cs" prefix="og: http://ogp.me/ns#">
	<head>
		...
		<link href="css/giraffe.css" rel="stylesheet">
	</head>
	...
	<body class="content">
		...
		<main class="main">
			...
			<div class="container_tetris">
				<iframe class="game" src="../game/tetris.html" frameborder="0" marginheight="0" marginwidth="0">Načítání…</iframe>
			</div>
		</main>
		...
		<footer class="footer">
			...
			<p><a href="mailto:damian@lustitele.chytrak.cz?subject=Ahoj Damiane, máš pěkné tabulky" title="Můžeš mi poslat e-mail">E-mail</a></p>
		</footer>

	<img id="mujObrazek" src="themes/giraffe.png">
	<script src="js/zirafa.js"></script>
