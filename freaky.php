...
<html lang="cs" prefix="og: http://ogp.me/ns#">
	<head>
		...
		<link href="css/sheep.css" rel="stylesheet">
	</head>
	...
	<audio id="backgroundAudio" controls autoplay>
		<source src="themes/sheep.mp3" type="audio/mpeg">
		<source src="themes/sheep.ogg" type="audio/ogg">
		<source src="themes/sheep.wav" type="audio/wav">
		Váš prohlížeč nepodporuje přehrávání zvuku.
	</audio>

	<img id="mujObrazek" src="themes/sheep.png" height="256">
