...
# Počet herních dnů
	...
	$file = fopen("./CSV/vitezna.csv", "r");

	$pocethracu = tisktabulky($file);

	echo "\n\t\t<tfoot><tr><th class=\"footleft\"></th><th class=\"foot\">Dnes odehrálo: </th><th class=\"foot\">" . $pocethracu - 1 . "</th><th class=\"foot\"> hráčů</th><th class=\"foot\"></th><th class=\"footright\"></th></tr></tfoot>\n\t</tbody>\n</table>\n";
